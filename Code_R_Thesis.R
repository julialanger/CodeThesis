...
ovarian <- ovarian[ , c(1,4,5,6,8,10,14,21,23,24,25,26,27)]
...
for (i in 1:M){
  ...
  s.obs<-surv$chisq
  ovariansimple<-ovariansimple[,1:13]
...
plot(mean_distr,type="h",main="Distribution of 500 patients strata from 3 factors",xlab="All the different strata",ylab="Number of patients",lwd=3)
#################################Power###############################################
...
plot(mean_distr2,type="h",main="Distribution of 500 patients strata from 5 factors",xlab="All the different strata",ylab="Number of patients",lwd=3)
#################################Power############################################################
